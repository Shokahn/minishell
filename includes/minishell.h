...
char							**collect_cmd_args(t_token *start,
									t_token *end);
...
int								exec_heredoc(char *delimiter, t_redir *redir,
									t_data *data);
void							close_heredoc(t_cmd *cmd);
void							init_heredoc(t_data *data);
char							*expand_string_heredoc(char *inside,
									t_data *shell);
int								extract_variable_heredoc(char **inside, int i,
									t_data *shell);
